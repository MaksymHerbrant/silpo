...
RULES: list[SwapRule] = [
    SwapRule(
        ...
        queries=[
            "Вода мінеральна негазована", "Вода Моршинська негазована",
            "Напій Coca-Cola Zero", "Чай холодний без цукру",
            "Вода з лимоном без цукру", "Напій Pepsi Max",
        ],
        reason="менше цукру при тій самій ролі «щось попити»",
    ...
    SwapRule(
        key="energy_drink",
        title="Енергетик",
        queries=["Напій енергетичний без цукру", "Кава холодна без цукру", "Вода мінеральна"],
        reason="без цукру й з меншою калорійністю",
    ...
    SwapRule(
        ...
        queries=["Сік 100% без цукру", "Сік прямого віджиму", "Вода мінеральна негазована"],
        reason="без доданого цукру",
